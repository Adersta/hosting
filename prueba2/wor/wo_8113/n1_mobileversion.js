...
create:function () 
{
	...
	//HUD
	text = game.add.text(w/2 - 180, 0+40,"puntuacion: " + score);
	...
	buttonjump = game.add.button(w/2-100, h/2-200, 'buttonjump', null, this, 0, 1, 0, 1);  //game, x, y, key, callback, callbackContext, overFrame, outFrame, downFrame, upFrame
	...
	buttonleft = game.add.button(0, h/2-100 , 'buttonhorizontal', null, this, 0, 1, 0, 1);
	...
	buttonright = game.add.button(160, h/2 -100, 'buttonhorizontal', null, this, 0, 1, 0, 1);
	...
	buttondown = game.add.button(96,h/2 -50, 'buttonvertical', null, this, 0, 1, 0, 1);
...
update:function () 
{
	...
	if(jump && (player.body.onFloor() || player.body.touching.down)){ 
...
quest:function(){
	...
	choiseLabel = game.add.text(w/4, h/4 + 10 , ''+preguntas[RanQuest], { font: '30px Arial', fill: '#fff' });
	choiseLabel.anchor.setTo(0.5, 0.5);
	choiseLabel.fontSize = 25;
	choiseLabel.fixedToCamera = true;

	contextlabel = game.add.text(w/4, h/4 + 40, ''+contextPreguntas[RanQuest], { font: '30px Arial', fill: '#fff' });
	contextlabel.anchor.setTo(0.5, 0.5);
	contextlabel.fixedToCamera = true;
	contextlabel.fontSize = 25;
