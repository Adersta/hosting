...
create:function () 
{
    ...
    scoreText = game.add.text(32, 15, 'score: 0', { font: "20px Arial", fill: "#ffffff", align: "left" });
    livesText = game.add.text(500, 15, 'lives: 3', { font: "20px Arial", fill: "#ffffff", align: "left" });
