...
create:function () 
{
    ...
    //UI
    scoreText = game.add.text(32, 550, 'score: 0', { font: "20px roboto", fill: "#ffffff", align: "left" });
    livesText = game.add.text(w-100, 550, 'lives: 3', { font: "20px roboto", fill: "#ffffff", align: "left" });
    introText = game.add.text(game.world.centerX, 400, '- click to start -', { font: "40px roboto", fill: "#ffffff", align: "center" });
    ...
    //RESA
let res0a = game.add.button(250, 200, 'res0a',this.Afunction, this,2, 1, 0);
resa.push(res0a);
let res1a = game.add.button(250, 200, 'res1a',this.Afunction, this,2, 1, 0);
resa.push(res1a);
let res2a = game.add.button(250, 200, 'res2a', this.Afunction, this,2, 1, 0);
resa.push(res2a);
let res3a = game.add.button(250, 200, 'res3a', this.Afunction, this,2, 1, 0);
resa.push(res3a);
...
//RESB
let res0b = game.add.button(250, 300, 'res0b',this.Bfunction, this,2, 1, 0);
resb.push(res0b);
let res1b = game.add.button(250, 300, 'res1b',this.Bfunction, this,2, 1, 0);
resb.push(res1b);
let res2b = game.add.button(250, 300, 'res2b',this.Bfunction, this,2, 1, 0);
resb.push(res2b);
let res3b = game.add.button(250, 300, 'res3b',this.Bfunction, this,2, 1, 0);
resb.push(res3b);
...
//RESC
let res0c = game.add.button(250, 400, 'res0c',this.Cfunction, this,2, 1, 0);
resc.push(res0c);
let res1c = game.add.button(250, 400, 'res1c',this.Cfunction, this,2, 1, 0);
resc.push(res1c);
let res2c = game.add.button(250, 400, 'res2c',this.Cfunction, this,2, 1, 0);
resc.push(res2c);
let res3c = game.add.button(250, 400, 'res3c',this.Cfunction, this,2, 1, 0);
resc.push(res3c);
...
//RESD
let res0d = game.add.button(250, 500, 'res0d',this.Dfunction, this,2, 1, 0);
resd.push(res0d);
let res1d = game.add.button(250, 500, 'res1d',this.Dfunction, this,2, 1, 0);
resd.push(res1d);
let res2d = game.add.button(250, 500, 'res2d',this.Dfunction, this,2, 1, 0);
resd.push(res2d);
let res3d = game.add.button(250, 500, 'res3d',this.Dfunction, this,2, 1, 0);
resd.push(res3d);
...
//RESE
let res0e = game.add.button(250, 600, 'res0e',this.Efunction, this,2, 1, 0);
rese.push(res0e);
let res1e = game.add.button(250, 600, 'res1e',this.Efunction, this,2, 1, 0);
rese.push(res1e);
let res2e = game.add.button(250, 600, 'res2e',this.Efunction, this,2, 1, 0);
rese.push(res2e);
let res3e = game.add.button(250, 600, 'res3e',this.Efunction, this,2, 1, 0);
rese.push(res3e);
