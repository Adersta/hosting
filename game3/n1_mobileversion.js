...
create:function () 
{
	...
	buttonjump = game.add.button(w-100, h-200, 'buttonjump', null, this, 0, 1, 0, 1);  //game, x, y, key, callback, callbackContext, overFrame, outFrame, downFrame, upFrame
	...
	buttonleft = game.add.button(0, h-200 , 'buttonhorizontal', null, this, 0, 1, 0, 1);
	...
	buttonright = game.add.button(160, h -200, 'buttonhorizontal', null, this, 0, 1, 0, 1);
	...
	buttonup = game.add.button(96,h -250, 'buttonvertical', null, this, 0, 1, 0, 1);
	...
	buttondown = game.add.button(96,h -150, 'buttonvertical', null, this, 0, 1, 0, 1);
