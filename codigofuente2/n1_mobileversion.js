...
quest:function(){
	...
	// Then add the menu
	menu = game.add.sprite(w/4, h/4 + -200, 'menu');
	menu.anchor.setTo(0.5, 0.5);
	menu.fixedToCamera = true;

	// And a label to illustrate which menu item was chosen. (This is not necessary)
	choiseLabel = game.add.text(w/4, h/4 - 50 , ''+preguntas[RanQuest], { font: '30px Arial', fill: '#fff' });
	choiseLabel.anchor.setTo(0.5, 0.5);
	choiseLabel.fixedToCamera = true;

	contextlabel = game.add.text(w/4, h/4 + 0, ''+contextPreguntas[RanQuest], { font: '30px Arial', fill: '#fff' });
